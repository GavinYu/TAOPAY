...
@protocol TPNavigationProtocol <NSObject>
...
- (void)pushViewModel:(TPViewModel *)viewModel animated:(BOOL)animated;
...
- (void)presentViewModel:(TPViewModel *)viewModel animated:(BOOL)animated completion:(VoidBlock)completion;
...
///
/// viewModel - the view model
- (void)resetRootViewModel:(TPViewModel *)viewModel;
