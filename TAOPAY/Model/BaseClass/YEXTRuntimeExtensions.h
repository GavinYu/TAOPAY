...
typedef enum {
   ...
   */
  y_propertyMemoryManagementPolicyAssign = 0,
  
  /**
   * The value is retained.
   */
  y_propertyMemoryManagementPolicyRetain,
  
  /**
   * The value is copied.
   */
  y_propertyMemoryManagementPolicyCopy
} y_propertyMemoryManagementPolicy;
...
typedef struct {
   ...
   */
  y_propertyMemoryManagementPolicy memoryManagementPolicy;
