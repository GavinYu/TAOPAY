...
/// 请求Method
/// GET 请求
#define Y_HTTTP_METHOD_GET @"GET"
/// HEAD
#define Y_HTTTP_METHOD_HEAD @"HEAD"
/// POST
#define Y_HTTTP_METHOD_POST @"POST"
/// PUT
#define Y_HTTTP_METHOD_PUT @"PUT"
/// POST
#define Y_HTTTP_METHOD_PATCH @"PATCH"
/// DELETE
#define Y_HTTTP_METHOD_DELETE @"DELETE"
...
@interface YURLParameters : NSObject
/// 路径 （v14/order）
...
/**
 参数配置（统一用这个方法配置参数） （http://hanshanghai.net:8081/）
